    ...
    <main>
      ...
      <section className="position-relative z-index-2 py-0 mb-n7">
        <div className="container position-relative">
          <div className="bg-dark rounded position-relative overflow-hidden p-4 p-sm-5">
            {/* SVG украшение */}
            ...
            <div className="row g-4 position-relative">
              ...
              <div className="col-lg-7 mx-auto text-center">
                {/* Заголовок */}
                <h2 className="text-white mb-4">Давайте работать вместе</h2>
      ...
      {/* =======================
      Футер НАЧАЛО */}
      <footer className="bg-dark position-relative overflow-hidden pb-0 pt-4 pt-lg-6" data-bs-theme="dark">
        {/* SVG украшение */}
        <figure className="position-absolute top-0 start-0 mt-n8 ms-n9">
          <svg className="fill-mode" width="775px" height="834px" viewBox="0 0 775 834" style={{ enableBackground: 'new 0 0 775 834', opacity: 0.05 }} xmlSpace="preserve">
